...
const BreakingNews = ({ breakingNews }) => {
  ...
  return (
    <div className="mb-4 flex w-full max-w-3xl items-center justify-between space-x-1 rounded-lg bg-red-600 px-2 py-[6px] text-xs text-white shadow-md sm:mb-4 sm:space-x-2 sm:text-sm lg:rounded-full lg:px-4">
