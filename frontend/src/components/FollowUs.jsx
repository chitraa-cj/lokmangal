...
const FollowUs = () => {
  ...
  return (
    <>
      <div className="h-fit w-[180px] space-y-4 rounded-lg bg-white p-4 text-center shadow-lg">
        {/* <div className="max-w-xs space-y-4 rounded-xl bg-white p-4 text-center shadow-md"> */}
        <div className="py-3">
          <Link to="/">
