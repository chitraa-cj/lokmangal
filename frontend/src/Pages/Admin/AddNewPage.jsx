        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="rounded-lg bg-white p-4 shadow-lg">
              ...
              <Select
                options={categoryOptions} // Reusing categories for simplicity; adjust if needed
                value={categoryOptions.find(
            ...
            {/* Conclusion */}
            <div className="rounded-lg bg-white p-4 shadow-lg md:col-span-2">
              {/* <label className="mb <div className="rounded-lg bg-white p-4 shadow-lg md:col-span-2"> */}
              <label className="mb-2 block text-sm font-medium text-gray-700">
                Conclusion <span className="text-red-500">*</span>
              </label>
              <textarea
